...
import com.bside.starterapi.application.TokenRefreshException;
...
public class ExceptionAdvice {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ExceptionHandler
    public ErrorResponse handleAlreadyExistsUsernameException(AlreadyExistsUsernameException e) {
        return new ErrorResponse(
                HttpStatus.BAD_REQUEST.value(),
                e.getMessage()
        );
